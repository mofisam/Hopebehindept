      ...
      <div class="col-md-4">
        <div class="card h-100 border-0 shadow-sm">
          <div class="card-body text-center p-4">
            <img src="/images/testimonial-1.jpg" class="rounded-circle mb-3" width="100" height="100" alt="Maria's story" style="object-fit: cover;">
            <h4 class="h5">Maria's Journey</h4>
            <p class="mb-3">"The debt relief program helped me eliminate ₦45,000 in credit card debt and taught me how to budget effectively."</p>
            ...
            <small class="text-muted">Former participant, now debt-free</small>
          </div>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card h-100 border-0 shadow-sm">
          <div class="card-body text-center p-4">
            <img src="/images/testimonial-2.jpg" class="rounded-circle mb-3" width="100" height="100" alt="James' story" style="object-fit: cover;">
            <h4 class="h5">James' Transformation</h4>
            <p class="mb-3">"After attending the financial literacy workshops, I paid off my car loan and started investing for the first time."</p>
            <div class="text-warning mb-2">
              <i class="fas fa-star"></i>
              <i class="fas fa-star"></i>
              <i class="fas fa-star"></i>
            ...
            <small class="text-muted">Workshop graduate</small>
          </div>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card h-100 border-0 shadow-sm">
          <div class="card-body text-center p-4">
            <img src="/images/testimonial-3.jpg" class="rounded-circle mb-3" width="100" height="100" alt="The Johnsons' story" style="object-fit: cover;">
            <h4 class="h5">The Johnsons Family</h4>
            <p class="mb-3">"We eliminated ₦92,000 in medical debt through the program and finally bought our first home last year."</p>
            <div class="text-warning mb-2">
              <i class="fas fa-star"></i>
              <i class="fas fa-star"></i>
              <i class="fas fa-star"></i>
            ...
            <small class="text-muted">Debt relief recipients</small>
          </div>
        </div>
      </div>
    </div>
      ...
      if (count < target) {
        const updateCount = () => {
          ...
          if (current < target) {
            ...
            } else if (counter.classList.contains('text-warning')) {
              counter.innerText = target + '%';
            } else if (counter.classList.contains('text-primary') && target > 1000) {
